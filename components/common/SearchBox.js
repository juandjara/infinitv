...
import { ClockIcon, SearchIcon, XIcon as CloseIcon } from '@heroicons/react/solid'
  ...
  return (
    <div className="md:relative">
      <Button
        ...
        background="bg-primary-900 hover:bg-primary-700"
        color="text-white"
        border="border-none"
      ...
      <form
        ...
        <input
          ...
          className="w-full md:w-64 bg-primary-900 h-8 pl-9 pr-9 text-base placeholder-gray-200 placeholder-opacity-50 border-transparent rounded-md focus:outline-none focus:ring-1 focus:ring-primary-700 focus:border-primary-700"
        />
        <Button
          small
          hasIcon="only"
