      ...
      <div
        ...
        <section>
          ...
          <input
            ...
            className="bg-primary-200 text-gray-700 block w-full h-10 pl-3 pr-2 text-base placeholder-gray-500 border border-none rounded-md focus:outline-none focus:ring-1 focus:ring-primary-700 focus:border-primary-700"
          />
        </section>
        <section>
